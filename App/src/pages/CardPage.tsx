...
const CardPage = ({ targetRef }: { targetRef: React.RefObject<HTMLDivElement> }) => {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden flex justify-center items-center">
      {currentImg === "/public/DrikkVannCard.png" && <div ref={targetRef} className="absolute inset-0 z-10"></div>}
      <button
        className="w-full h-full overflow-hidden flex justify-center items-center object-cover"
